...
namespace ProdutosApp.Infra.Data.Tests.Facts
{
    ...
    public class ProdutoRepositoryFact
    {
        ...
        public async Task AdicionarProdutoComSucesso()
        {
            ...
            var registro = await _unitOfWork.ProdutoRepository.GetByIdAsync(produto.Id.Value);
        ...
        public async Task AtualizarProdutoComSucesso()
        {
            ...
            var atualizado = await _unitOfWork.ProdutoRepository.GetByIdAsync(produto.Id.Value);
        ...
        public async Task ExcluirProdutoComSucesso()
        {
            ...
            var excluido = await _unitOfWork.ProdutoRepository.GetByIdAsync(produto.Id.Value);
